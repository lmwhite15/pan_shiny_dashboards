...
with_drive_quiet(
  drive_download(as_id("https://drive.google.com/file/d/1qa2MeTjZMNQQep4EIPOh0MMKCY2-M8Jc"),
                 overwrite = TRUE)
)
load(file = "pan_games_files_list.Rdata")

dat <- read.csv(textConnection(getURL(hmlfile, userpwd=logininfo, ftp.ssl=TRUE)), header = T)
