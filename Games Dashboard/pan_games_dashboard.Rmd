...
participant_data <- info_hml_id_data %>%
  ...
  mutate(participant_id = case_when(hml_id == "HML0765" ~ "003Vu00000hTICAIA4",
                                    ...
                                    TRUE ~ participant_id)) %>%
  # 2026-05-11: Same as above
  mutate(participant_id = case_when(hml_id == "HML1318" ~ "003Vu00001tEcN1IAK",
                                    TRUE ~ participant_id)) %>%
  # 2026-07-16: Same as above
  mutate(participant_id = case_when(hml_id == "HML1147" ~ "003Vu000016eCZeIAM",
                                    hml_id == "HML1211" ~ "003Vu00000P6tprIAB",
                                    TRUE ~ participant_id)) %>%
  distinct() %>%
